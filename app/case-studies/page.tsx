      ...
      <section className="relative pt-36 lg:pt-44 pb-12 lg:pb-16 px-6 overflow-hidden">
        ...
        <FadeInSection className="max-w-7xl mx-auto">
          ...
          <div className="mt-24 lg:mt-32 text-center glass-card rounded-3xl p-10 lg:p-16 border-white/5 bg-gradient-to-t from-[#13315C] to-transparent">
            ...
            <Link href="/consultation" className="inline-block bg-yellow-400 text-black px-8 md:px-12 py-5 rounded-xl font-bold text-lg hover:bg-yellow-300 transition-all shadow-xl shadow-yellow-400/20">
