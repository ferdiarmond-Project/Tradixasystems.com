      ...
      <main className="relative min-h-screen flex items-center justify-center pt-24 pb-12 px-6 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl animate-fade-up">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400">Masuk ke akun Tradixa Anda</p>
          </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#071A2E] px-2 text-gray-500">Atau masuk dengan</span>
            </div>
          </div>
          ...
          <button
            ...
            type="button"
            className="w-full bg-white text-black font-semibold py-3.5 rounded-xl transition-all shadow-xl hover:bg-gray-100 flex items-center justify-center gap-3 active:scale-95"
          >
